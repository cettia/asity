 ...
 * 
 * <pre>
 * Servlet servlet = new CettiaAtmosphereServlet().onhttp(http -&gt {}).onwebsocket(ws -&gt {});
...
public class CettiaAtmosphereServlet extends AtmosphereServlet {
     ...
     * available.
     */
    public CettiaAtmosphereServlet onhttp(Action<ServerHttpExchange> action) {
     ...
     * available.
     */
    public CettiaAtmosphereServlet onwebsocket(Action<ServerWebSocket> action) {
