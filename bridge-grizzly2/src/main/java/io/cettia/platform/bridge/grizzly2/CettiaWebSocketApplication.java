 ...
 * WebSocketEngine.getEngine().register("", "/cettia", new CettiaWebSocketApplication().onwebsocket(ws -&gt {}));
 * </pre>
 *
 * @author Donghwan Kim
 */
public class CettiaWebSocketApplication extends WebSocketApplication {
     ...
     * available.
     */
    public CettiaWebSocketApplication onwebsocket(Action<ServerWebSocket> action) {
