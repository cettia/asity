...
public class JwaServerWebSocketTest extends ServerWebSocketTest {
    ...
    protected void startServer() throws Exception {
        ...
        ServerEndpointConfig config = ServerEndpointConfig.Builder.create(CettiaServerEndpoint.class, "/test")
        .configurator(new Configurator() {
            @Override
            public <T> T getEndpointInstance(Class<T> endpointClass) throws InstantiationException {
                return endpointClass.cast(new CettiaServerEndpoint().onwebsocket(performer.serverAction()));
            }
        })
        .build();
