 ...
 * @author Donghwan Kim
 */
public class CettiaServerCodec extends ChannelInboundHandlerAdapter {
     ...
     * available.
     */
    public CettiaServerCodec onhttp(Action<ServerHttpExchange> action) {
     ...
     * available.
     */
    public CettiaServerCodec onwebsocket(Action<ServerWebSocket> action) {
