 ...
 * @author Donghwan Kim
 */
public class SpringWebFluxServerWebSocketTest extends ServerWebSocketTestBase {
  ...
  protected void startServer(int port, Action<ServerWebSocket> websocketAction) {
    ...
    AsityWebSocketHandler asityWebSocketHandler = ctx.getBean(AsityWebSocketHandler.class);
    asityWebSocketHandler.onwebsocket(websocketAction);
  }
