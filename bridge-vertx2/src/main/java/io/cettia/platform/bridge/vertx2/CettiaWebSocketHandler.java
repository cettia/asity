 ...
 * 
 * <pre>
 * httpServer.websocketHandler(new CettiaWebSocketHandler().onwebsocket(http -&gt {}));
 * </pre>
 *
 * @author Donghwan Kim
 */
public class CettiaWebSocketHandler implements Handler<org.vertx.java.core.http.ServerWebSocket> {
     ...
     * available.
     */
    public CettiaWebSocketHandler onwebsocket(Action<ServerWebSocket> action) {
